...
public class AndroidFragment extends Fragment {
    ...
    private AndroidAdapter nameAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<String> androidList = Arrays.asList(getResources().getStringArray(R.array.android_names));
        nameAdapter = new AndroidAdapter(androidList);
