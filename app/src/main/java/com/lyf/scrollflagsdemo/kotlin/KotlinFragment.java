...
public class KotlinFragment extends Fragment {
    ...
    private KotlinAdapter mAdapter;
    ...
    public static KotlinFragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<String> kotlinList = Arrays.asList(getResources().getStringArray(R.array.kotlin_names));
        mAdapter = new KotlinAdapter(kotlinList);
